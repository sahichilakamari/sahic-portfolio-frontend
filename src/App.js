...
function App() {
  ...
  useEffect(() => {
    axios.get("https://your-backend-url.onrender.com/portfolio")
  ...
  return (
    <div className={`app-container ${theme}`}>
      ...
      <div className="section"><h2>Education</h2><ul>
      ...
      <div className="section"><h2>Skills</h2>
        {portfolio.skills && Object.entries(portfolio.skills).map(([cat, skills]) => (
          <div key={cat}>
            <strong>{cat}</strong>
      ...
      <div className="section"><h2>Projects</h2><ul>
      ...
      <div className="section"><h2>Internships</h2><ul>
      ...
      <div className="section"><h2>Certifications</h2><ul>
        {portfolio.certifications?.map((cert, i) => <li key={i}>{cert}</li>)}
      </ul></div>

      <div className="section"><h2>Achievements</h2><ul>
